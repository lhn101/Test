function [timestamps,values]=load_data_demo_2
...
data.temperature.data_raw=data.temperature.ll.mean+data.temperature.S2.data+data.temperature.AR.data;
...
values=[data.temperature.observation];
