...
t_idx=rem((t_idx-t_ref(1))/delta_t_ref,1);
if t_idx<0;
    t_idx=t_ref(1)+(1+t_idx)*delta_t_ref;
else
    t_idx=t_ref(1)+t_idx*delta_t_ref;
end
...
interp_hc=interp1(reg_time,reg_values,t_idx,'spline')-mean([0 reg_parameters]);
